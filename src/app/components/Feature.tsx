        ...
        <div className="mx-auto px-4 sm:px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-5 justify-items-center">
            {features.map((feature, index) => (
              ...
              >
                <div className="h-[313px] w-[363px] bg-gray-100 rounded-2xl overflow-hidden relative mx-auto mt-3">
                  <Image 
                    src={feature.image}
                ...
                <div className="mt-[24px] mb-[51px] mx-[24px]">
                  <h3 className="font-['DM_Sans'] font-extrabold text-lg sm:text-xl lg:text-2xl text-[#464646] mb-[8px] text-left leading-[160%]">
                    {feature.title}
                  </h3>
                  <p className="font-['DM_Sans'] font-medium text-[14px] sm:text-[16px] text-[#464646]/80 text-left leading-[140%]">
                    {feature.description}
                  </p>
                </div>
              </motion.div>
